...
public class ModBiomes {
    ...
    public static Biome testBiome(Registerable<Biome> context) {
        ...
        spawnBuilder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(unfassbarer.testmod.entity.ModEntities.PORCUPINE, 2, 3, 5));
        ...
        return new Biome.Builder()
                ...
                .effects((new BiomeEffects.Builder())
                        ...
                        .music(MusicType.createIngameMusic(RegistryEntry.of(Sounds.NETHER_STAR_CORE_2))).build())
                .build();
    }
    ...
    public static Biome testBiome2(Registerable<Biome> context) {
        ...
        return new Biome.Builder()
                ...
                .effects((new BiomeEffects.Builder())
                        ...
                        .fogColor(0x22a1e6)
                        .moodSound(BiomeMoodSound.CAVE)
                        .music(MusicType.createIngameMusic(RegistryEntry.of(Sounds.GUN_SHOOT))).build())
                .build();
    }
}
