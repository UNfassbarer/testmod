...
public class PatternProvider extends BlockWithEntity implements BlockEntityProvider {
    ...
    public static final MapCodec<PatternProvider> CODEC = PatternProvider.createCodec(PatternProvider::new);

    public PatternProvider(Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new PatternProviderEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.PATTERN_PROVIDER_ENTITY,
