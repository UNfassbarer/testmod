...
public class TestModBlocks {
    public static final Block Ardenim_Block =
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).create().strength(4.0F,1.0F).requiresTool());
    public static final Block Smooth_Ardenim_Block =
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).create().strength(4.0F,1.0F).requiresTool());
    public static final Block Ardenim_Pillar_Block =
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).create().strength(4.0F,1.0F).requiresTool());
    ...
    public static final Block Ardenim_Stairs =
            new StairsBlock(TestModBlocks.Ardenim_Block.getDefaultState(),FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).create().strength(4.0F,1.0F).requiresTool());
    public static final Block Ardenim_Slab =
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).create().strength(4.0F,1.0F).requiresTool());
    public static final Block Ardenim_Brick_Stairs =
            new StairsBlock(TestModBlocks.Ardenim_Brick_Block.getDefaultState(),FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).create().strength(4.0F,1.0F).requiresTool());
    ...
    public static final Block Ardenim_Glass =
            new StainedGlassBlock(DyeColor.WHITE,FabricBlockSettings.copyOf(Blocks.GLASS).create().sounds(BlockSoundGroup.GLASS).strength(0.5F,1.0F).requiresTool().nonOpaque());
    public static final Block Ardenim_Glass_Pane =
            new StainedGlassPaneBlock(DyeColor.WHITE,FabricBlockSettings.copyOf(Blocks.GLASS).create().sounds(BlockSoundGroup.GLASS).strength(0.5F,1.0F).requiresTool().nonOpaque());
