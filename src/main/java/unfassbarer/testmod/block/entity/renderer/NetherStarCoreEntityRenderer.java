...
public class NetherStarCoreEntityRenderer implements BlockEntityRenderer<NetherStarCoreEntity> {
    private static final float DAY_ROTATION_SPEED = 2.0f;
    private static final float NIGHT_ROTATION_SPEED = 32.0f;

    public NetherStarCoreEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(NetherStarCoreEntity entity, float tickDelta, MatrixStack matrices,
