...
public class ModTooltipManager {
    private static final Map<Item, String> ITEM_TOOLTIP = new HashMap<>();
    static {
        ITEM_TOOLTIP.put(TestModItems.Ardenimium_Gun, "seames that here is some ammo required ... ");
        ...
        ITEM_TOOLTIP.put(fromBlock(TestModBlocks.Nether_Star_Core), "Needs to be placed 2 blocks above the Solar Strabilizer");
